...
public class PaulosExperiments {
    ...
    private static void calculate() throws Exception {
        final File file = new File("/home/paulograbin/Desktop/measurements.txt");
    ...
    private static class ChunkProcessor implements Runnable {
        ...
        private StatsAcc ensureAcc(long hash, long nameStartOffset, int nameLen, long nameWord0, long nameWord1, long lastNameWord
        ) {
    ...
    static class StatsAcc {
        ...
        boolean nameEquals(long inputNameStart, long inputNameLen, long inputWord0, long inputWord1, long lastInputWord) {
